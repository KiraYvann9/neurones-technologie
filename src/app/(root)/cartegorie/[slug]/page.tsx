...
import girl from '../../../../../public/assets/detail_cartegorie/girl.jpg'
    ...
    return (
        <div className={'w-full flex justify-center'}>
            ...
            <MaxWidthWrapper className={'w-full flex flex-col items-center'}>
                ...
                <section className={'h-[631px] w-full bg-formation-section1 bg-contain bg-no-repeat flex justify-center items-center'}>
                    ...
                    <MinWidthWrapper className={'w-full '}>
                        <div className={'flex gap-1'}>
                            ...
                            <div className={'min-w-[289px] min-h-[458px] object-fill'} > 
                                <Image src={girl} alt={''} objectFit="contain" />
                            </div>
                ...
                <section className={'h-[436px] w-full bg-custom-black bg-formation-section2 bg-cover bg-left bg-no-repeat flex items-center justify-center'}>
