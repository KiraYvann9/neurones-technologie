...
export default function Contact(){
    return(
        <div className="w-full flex justify-center">
            <MaxWidthWrapper className="w-full min-h-screen pt-[55px] xl:pt-[80px] w-full flex justify-center items-start">
                <div className="flex flex-col items-center justify-start w-full min-h-screen pt-0 pb-3 xl:pt-10 bg-custom-blue bg-auth-bg bg-cover bg-left-bottom bg-no-repeat">
                    ...
                    <Tabs defaultValue="account" className=" xl:w-[1100px] space-y-8 justify-start mt-16 mx-4 xl:mx-0">
